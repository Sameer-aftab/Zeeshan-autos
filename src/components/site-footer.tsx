      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 grid md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          ...
          <p className="text-muted-foreground text-sm max-w-sm leading-relaxed">
            Authorized Suzuki 3S dealership serving Hyderabad and Sindh.
            Sales · Service · Spare Parts · Exchange.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li><Link to="/showroom" className="hover:text-primary">New Vehicles</Link></li>
            <li><Link to="/used" className="hover:text-primary">Certified Used</Link></li>
            <li><Link to="/exchange" className="hover:text-primary">Exchange Program</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li><Link to="/workshop" className="hover:text-primary">Workshop</Link></li>
            <li><Link to="/parts" className="hover:text-primary">Spare Parts</Link></li>
