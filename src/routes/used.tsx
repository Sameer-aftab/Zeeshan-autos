...
export const Route = createFileRoute("/used")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "130-point inspected, fully serviced certified used Suzuki cars in Hyderabad with limited warranty and full service history." },
    ],
  }),
  component: UsedPage,
});
...
const used = [
  { name: "Suzuki Swift DLX", year: 2022, km: "18,500", history: "Full service history", price: "PKR 4,250,000", img: heroImg },
  { name: "Suzuki Cultus VXL", year: 2021, km: "32,000", history: "Single owner", price: "PKR 3,180,000", img: cultusImg },
  { name: "Suzuki Wagon R VXL", year: 2021, km: "34,000", history: "Dealer maintained", price: "PKR 2,640,000", img: wagonrImg },
  { name: "Suzuki Alto VXR", year: 2022, km: "21,000", history: "First owner", price: "PKR 2,290,000", img: altoImg },
];
    ...
    <div>
      <section className="px-6 lg:px-8 pt-16 pb-20 max-w-7xl mx-auto">
        <SectionHeading
          ...
          title={<>Certified <span className="text-primary">used cars</span></>}
      ...
      <section className="px-6 lg:px-8 pb-20 max-w-7xl mx-auto grid sm:grid-cols-3 gap-px bg-border rounded-2xl overflow-hidden border border-border">
        {[
          ...
          <div key={l} className="bg-background p-8 text-center">
            ...
            <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-2">{l}</div>
          </div>
        ))}
      </section>
      ...
      <section className="px-6 lg:px-8 pb-32 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {used.map((c) => (
            <article key={c.name} className="rounded-3xl overflow-hidden border border-border bg-surface/40 hover:border-primary/40 transition-all group">
              <div className="grid grid-cols-5">
                ...
                <div className="col-span-3 p-7 flex flex-col">
                  ...
                  <div className="mt-auto pt-5 flex items-center justify-between">
                    ...
                    <Link to="/contact" className="size-9 rounded-full border border-border grid place-items-center hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all">
