  ...
  head: () => ({
    meta: [
      { title: "Genuine Suzuki Parts & Car Care — Online Shop | Zeeshan Autos" },
      {
        name: "description",
        content:
          "Genuine Suzuki spare parts, engine oils, oil filters, brake pads, spark plugs and premium car care products. Doorstep delivery across Sindh.",
      },
        ...
        <div className="relative max-w-7xl mx-auto">
          <SectionHeading
            ...
            title={
              <>
                Spare parts <br />
                <span className="text-primary">& car care</span>
              </>
            }
      ...
      <section className="px-6 lg:px-8 pb-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((c) => (
            <div
              key={c.name}
              className="rounded-3xl border border-border bg-surface/40 p-8 hover:border-primary/40 transition-all group"
            >
              ...
              <div className="mt-6 pt-6 border-t border-border flex items-center justify-between">
                ...
                <Link
                  to="/contact"
                  className="size-9 rounded-full border border-border grid place-items-center hover:bg-primary hover:border-primary hover:text-primary-foreground transition-all"
                >
        ...
        <div className="rounded-3xl border border-border bg-surface/60 p-10 lg:p-14 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Order any part on WhatsApp or by phone — we deliver across Hyderabad within 24 hours.
              Cash on delivery available.
            </p>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-7 py-4 bg-primary text-primary-foreground text-[11px] font-bold uppercase tracking-widest rounded-full hover:bg-primary-glow transition-all"
            >
