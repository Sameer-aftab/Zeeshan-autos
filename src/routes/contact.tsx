...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Visit Zeeshan Autos at Main Auto-Bhan Road, Latifabad, Hyderabad. Call +92 22 263 4451 or message us on WhatsApp." },
    ],
  }),
...
const info = [
  { icon: MapPin, label: "Showroom", value: "Main Auto-Bhan Road, Latifabad, Hyderabad, Sindh, Pakistan" },
    ...
    <div className="px-6 lg:px-8 pt-16 pb-32 max-w-7xl mx-auto">
      ...
      <div className="mt-16 grid lg:grid-cols-5 gap-8">
        <div className="lg:col-span-2 space-y-3">
          {info.map((i) => (
            <div key={i.label} className="rounded-2xl border border-border bg-surface/40 p-6 flex gap-5 hover:border-primary/40 transition-all">
