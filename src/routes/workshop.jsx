  ...
  head: () => ({
    meta: [
      { title: "Suzuki Workshop & Service — Hyderabad | Zeeshan Autos" },
      {
        name: "description",
        content:
          "Authorized Suzuki 3S workshop in Hyderabad. Computerized diagnostics, certified technicians, genuine parts. Book your service appointment.",
      },
...
const services = [
  {
    ...
    time: "45 mins",
    desc: "Genuine Suzuki engine oil and SGP oil filter replacement.",
  },
  {
    icon: Gauge,
    title: "Computerized Diagnostics",
    time: "30 mins",
    desc: "Full ECU scan, fault clearing, and performance analysis.",
  },
  {
    icon: Cog,
    title: "Brake Inspection & Tuning",
    time: "60 mins",
    desc: "Pad replacement, rotor check, and brake fluid flush.",
  },
  {
    icon: Wrench,
    title: "Major Tune-Up",
    time: "180 mins",
    desc: "Spark plugs, air filter, throttle clean, full inspection.",
  },
  {
    icon: ShieldCheck,
    title: "AC Service",
    time: "90 mins",
    desc: "Gas refill, condenser clean, system pressure test.",
  },
  {
    icon: Clock,
    title: "Annual Maintenance",
    time: "Half day",
    desc: "Comprehensive 60-point preventive maintenance package.",
  },
];
      ...
      <section className="relative px-6 lg:px-8 py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <SectionHeading
            ...
            title={
              <>
                The <span className="text-primary">workshop</span>
              </>
            }
      ...
      <section className="px-6 lg:px-8 py-20 max-w-7xl mx-auto">
        <div className="rounded-3xl border border-primary/30 bg-linear-to-br from-primary/15 via-background to-background p-10 lg:p-16 text-center">
          ...
          <p className="text-muted-foreground max-w-md mx-auto mb-8">
            8 service bays. Same-day delivery on most jobs. Pickup & drop available across
            Hyderabad.
          </p>
          <Link
            to="/book"
