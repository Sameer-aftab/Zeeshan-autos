  ...
  head: () => ({
    meta: [
      { title: "Suzuki Showroom — New Cars in Hyderabad | Zeeshan Autos" },
      {
        name: "description",
        content:
          "Browse the full 2025 Suzuki lineup at Zeeshan Autos: Alto, Cultus, Wagon R, Swift, Bolan, Ravi and more — with PKR pricing and on-road delivery.",
      },
          ...
          {cars.map((c, i) => (
            ...
            >
              ...
              <div className="p-7">
                ...
                <h3 className="font-display text-2xl uppercase tracking-tight mb-5">{c.name}</h3>
                ...
                <div className="flex items-end justify-between pt-4 border-t border-border">
                  ...
                  <Link
                    to="/contact"
                    className="size-10 rounded-full border border-border grid place-items-center hover:bg-primary hover:border-primary hover:text-primary-foreground transition-all"
                  >
