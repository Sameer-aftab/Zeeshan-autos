...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Suzuki new cars, certified used vehicles, workshop, exchange program and genuine spare parts in Hyderabad, Sindh, Pakistan." },
...
const services = [
  { n: "01", title: "New Cars", to: "/showroom", body: "Explore the 2025 Suzuki lineup with full warranty and 0-meter assurance.", cta: "View showroom" },
  { n: "02", title: "Workshop", to: "/workshop", body: "Authorized 3S maintenance by Suzuki-certified technicians with computerized diagnostics.", cta: "Book repair" },
  { n: "03", title: "Exchange", to: "/exchange", body: "Trade in any car and drive home a brand-new Suzuki at the best market rate.", cta: "Value my car" },
  { n: "04", title: "Certified Used", to: "/used", body: "130-point inspected pre-owned vehicles, fully serviced and warranty-backed.", cta: "Browse inventory" },
  { n: "05", title: "Spare Parts", to: "/parts", body: "Genuine Suzuki SGP parts, oils, filters and pro-grade car care products.", cta: "Shop parts" },
] as const;

const featured = [
  { name: "Suzuki Swift GLX CVT", spec: "1200cc · Automatic", price: "PKR 5,429,000", img: heroImg },
  ...
  return (
    <div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-12 gap-6 items-end">
          <div className="col-span-12 lg:col-span-7 animate-reveal">
            ...
            <p className="mt-8 max-w-md text-muted-foreground leading-relaxed text-pretty">
              Hyderabad's premier destination for Suzuki excellence. New cars,
              certified pre-owned, workshop service and genuine parts — all under
              one roof.
            </p>
      ...
      <section className="px-6 lg:px-8 py-32 max-w-7xl mx-auto">
        <SectionHeading
          eyebrow="What we do"
          title={<>The <span className="text-primary">ecosystem</span></>}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border rounded-3xl overflow-hidden border border-border">
          {services.map((s) => (
            ...
            >
              ...
              <h3 className="text-3xl font-display uppercase tracking-tight mt-4">
                {s.title}
              </h3>
      ...
      <section className="px-6 lg:px-8 py-32 bg-surface/40 border-y border-border">
        <div className="max-w-7xl mx-auto">
          <SectionHeading
            ...
            title={<>2025 <span className="text-primary">lineup</span></>}
      ...
      <section className="px-6 lg:px-8 py-32 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="relative rounded-3xl overflow-hidden border border-border min-h-[440px] group">
            <img src={workshopImg} alt="Suzuki workshop" loading="lazy" className="absolute inset-0 size-full object-cover group-hover:scale-105 transition-transform duration-1000" />
            ...
            <div className="relative z-10 h-full p-10 flex flex-col justify-end">
              ...
              <p className="text-muted-foreground max-w-sm mb-6 leading-relaxed">
                Suzuki-certified technicians, genuine tooling, computerized diagnostics. We keep your car in factory shape.
              </p>
              <Link to="/workshop" className="inline-flex w-fit items-center gap-2 px-6 py-3 bg-primary text-primary-foreground text-[10px] font-bold uppercase tracking-widest rounded-full hover:bg-primary-glow transition-all">
          ...
          <div className="relative rounded-3xl overflow-hidden border border-primary/30 bg-gradient-to-br from-primary/20 via-background to-background min-h-[440px] p-10 flex flex-col justify-end">
            ...
            <p className="text-muted-foreground max-w-sm mb-8 leading-relaxed">
              Bring any car. Drive home a brand-new Suzuki. Best market rates, paperwork handled in 24 hours.
            </p>
            ...
            <Link to="/exchange" className="inline-flex w-fit items-center gap-2 px-6 py-3 border border-primary text-foreground text-[10px] font-bold uppercase tracking-widest rounded-full hover:bg-primary hover:text-primary-foreground transition-all">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-muted-foreground mb-10 leading-relaxed max-w-md">
              SGP-certified Suzuki spare parts, premium engine oils, OEM filters and pro-grade car care products. Doorstep delivery across Sindh.
            </p>
            ...
            <Link to="/parts" className="inline-flex items-center gap-2 px-7 py-4 border-2 border-primary text-foreground text-[11px] font-bold uppercase tracking-widest rounded-full hover:bg-primary hover:text-primary-foreground transition-colors">
          ...
          <div className="relative">
            ...
            <div className="aspect-[4/5] rounded-3xl overflow-hidden border border-border">
              <img src={partsImg} alt="Genuine Suzuki parts" loading="lazy" className="size-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 lg:px-8 py-32 max-w-7xl mx-auto text-center">
        ...
        <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground text-[11px] font-bold uppercase tracking-widest rounded-full hover:bg-primary-glow transition-all shadow-glow">
